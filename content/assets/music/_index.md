...
{{<audio src="songs/musMainCave.ogg">}}
...
Genetics Lab 1:  
{{<audio src="songs/musArea7A.ogg">}}

Genetics Lab 2 pt. 1:  
{{<audio src="songs/musArea7B.ogg">}}

Genetics Lab 2 pt. 2:  
{{<audio src="songs/musArea7C.ogg">}}

# Final Corridor
This plays in the final corridor before the Metroid Queen Arena. The music file is called `musArea7D.ogg`.

{{<audio src="songs/musArea7D.ogg">}}
